...
export const LocationCard: FC<LocationCardProps> = ({ id, description, name, images, isSelected, onCardClick, onSelect }) => {
    ...
    return (
        <div
            ...
            {!isSelected && <div onClick={() => onCardClick(id)} className={s.btn}>Select</div>}
