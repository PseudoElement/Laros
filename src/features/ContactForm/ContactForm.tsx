    ...
    return (
        <div className={s.container}>
            <div className={s.main}>
                ...
                <div className={s.description}>In elit volutpat, quam egestas vel ut non. Maecenas sodales amet, aliquam, nisl semper justo, vitae enim tortor.</div>
                <div className={s.form}>
                    <Controller
                        name='name'
                        control={control}
                        render={({ field: { onChange, value } }) => (
                            <Input shorten placeholder='Name' onChange={onChange} id='name' value={value} label='Fullname and surname' />
                        )}
                    />
                    <Controller
                        name='title'
            ...
            <div className={s.info}>
                <div className={cn(s.infoItem, s.appointment)}>
                    ...
                    <div className={s.infoDescription}>Choose the date & time and let’s talk!</div>
                </div>
                ...
                <div className={cn(s.infoItem, s.socials)}>
                    ...
                    <div className={s.socialIcons}>
                        <div> <Image src={inst} width={20} height={20} /></div>
                        <div> <Image src={fb} width={20} height={20} /></div>
                        <div> <Image src={linked} width={20} height={20} /></div>
                    </div>
                </div>
