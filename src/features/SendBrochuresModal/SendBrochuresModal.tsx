                    ...
                    <form className={s.form}>
                        ...
                        <Controller
                            ...
                            render={({ field: { onChange, value } }) => (
                                <Input placeholder='Name' onChange={onChange} id='name' value={value} label='Fullname and surname' />
                            )}
                        />
                        <Controller
                            name='title'
                        ...
                        <div className={s.actions}>
                            ...
                            <Button onClick={handleSubmit(onSubmit)} type="submit" classname={s.downloadBtn}>send</Button>
                        </div>
                    </form>
                </div>
            </div>
