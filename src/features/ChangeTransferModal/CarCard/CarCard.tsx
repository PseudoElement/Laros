        ...
        <div className={s.card}>
            ...
            <div className={s.content}>
                ...
                <div className={s.item}>
                    <Image src={peopleGroup} /> <span className={s.capacity}>{capacity} people</span>

                </div>
                <div className={s.item}>
                    <Image src={luggageIcon} /> <span className={s.luggage}>{luggage} medium-sized bags or suitcases</span>
                </div>
                <div className={s.item}>
                    <CalendarIcon /> <span className={s.period}>1 Aug 2022 - 15 Sep 2022</span>
                    {/* TODO wait API */}
                </div>
            </div>
            <div className={s.total}>
                <div className={s.route}>
                    <div className={s.routeItem}>
                        <GeoTagIcon /> <span className={s.routePlace}>{from_dest_name}</span>
                    </div>
