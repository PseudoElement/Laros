        ...
        <DestinationLayout currentDestination={Number(null)} destinations={destinations}>
            <div className={s.container} style={{
                ...
                <div className={s.content}>
                    ...
                    <div className={s.description}>Turpis morbi nec enim id nulla vehicula condimentum. Curabitur fermentum vitae condimentum eu non imperdiet.</div>
                    <div className={s.actions}>
                        <Button onClick={() => router.push('requests/flights')} classname={s.flightBtn}>Flight request</Button>
                        <Button onClick={() => router.push('requests/packages')} classname={s.packageBtn}>Request package</Button>
                    </div>
                </div>
