    ...
    <div className={s.container}>
      <div className={s.transfer}>
        ...
        <div className={s.transferInfo}>
          ...
          <div className={s.transferRoute}>{from} &gt; {to}</div>
      ...
      <div className={s.content}>
        <span className={s.day}>Day {day}</span><span className={s.dayTotal}>out of {total}</span>
        ...
        <div className={cn(s.section, s.descriptionSection)}>
          ...
          <div className={s.description}>
            <div className={s.descriptionText}>{isTruncated ? truncate(description, { length: TRUNCATED_TEXT_SIZE }) : description}</div>
            {isTruncated && description?.length > TRUNCATED_TEXT_SIZE && <div onClick={() => setIsTruncated(false)} className={s.moreBtn}>More</div>}
          </div>
        </div>
        <div className={s.section}>
