        ...
        <div className={s.container}>
            ...
            <div className={s.filters}>
                ...
                <div className={s.filterSelects}>
                    ...
                    <div className={s.viewSwitch}>
                        <span onClick={() => setView(View.LIST)} className={cn(s.viewIcon, { [s.viewSelected]: view === View.LIST })}>
                            <Image src={listIcon} />
                        </span>
                        <span onClick={() => setView(View.GRID)} className={cn(s.viewIcon, { [s.viewSelected]: view === View.GRID })}>
                            <Image src={gridIcon} />
                        </span>
                    </div>
                </div>
            ...
            <div className={cn(s.offers, view === View.GRID ? s.grid : s.list)}>
                ...
                {!isLoading && trips?.length && trips.map((offer) => {
                    return <TripCard region={''} start={''} {...offer} wide={view === View.LIST} />
                })}
            </div>
        </div>
    )
