...
export const Counter: FC<CounterProps> = ({ onChange, value, min = 0, max }) => {
    ...
    return (
        <div className={s.counter}>
            <span onClick={() => handleDecrement()}><Image src={minDisabled ? minusDisabled : minus} width={24} height={24} /></span>
            <span onClick={() => handleIncrement()}><Image src={maxDisabled ? plusDisabled : plus} width={24} height={24} /></span>
        </div>
    )
}